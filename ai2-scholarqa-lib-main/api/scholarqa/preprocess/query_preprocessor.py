...
def decompose_query(query: str, decomposer_llm_model: str, publication_date: date, **llm_kwargs) -> Tuple[LLMProcessedQuery, CompletionResult]:
    search_filters = dict()
    ...
    try:
        ...
        decomposed_query.latest_search_year = publication_date
        #decompose_query.earliest_search_year = 1900
